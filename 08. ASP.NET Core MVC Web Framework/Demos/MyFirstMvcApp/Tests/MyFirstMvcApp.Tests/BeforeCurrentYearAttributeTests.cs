...
namespace MyFirstMvcApp.Tests
{
    public class BeforeCurrentYearAttributeTests
    {
        ...
        [InlineData(-2019, 1, false)]
        [InlineData(0, 0, true)] // *s
        [InlineData(-2019, -2019, true)] // *
        public void IsValidShouldWorkCorectly(int afterYear, int year, bool expected)
        {
            // Arrange
        ...
        public void IsValidWithCurrentYearShouldReturnTrue()
        {
            // Arrange
            var afterYear = 1900;
            var attribute = new BeforeCurrentYearAttribute();
