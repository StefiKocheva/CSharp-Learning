namespace DemoApp 
{
    ...
    public class Startup : IMvcApplication
    {
        ...
        // HomeConroller 
        public static HttpResponse Index(HttpRequest request) // To get the information from request and return the response.
        {
            ...
            var tweets = db.Tweets.Select(x => new
            {
                ...
                x.Creator,
                x.Content,
            }).ToList(); // Not foget to use ToList()
        ...
        // creator=Stefi&tweetName=blah blah <3
