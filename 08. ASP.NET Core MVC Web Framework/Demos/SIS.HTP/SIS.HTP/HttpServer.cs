    ...
    public class HttpServer : IHttpServer
    {
        ...
        private async Task ProcessClientAsync(TcpClient tcpClient)
        {
            ...
            try
            {
                ...
                string requesAsString = Encoding.UTF8.GetString(requestBytes, 0, bytesRead);

                var request = new HttpRequest(requesAsString); // We can use the parsed info by the request.
